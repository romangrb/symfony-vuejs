...
<template>
  <div class="card shadow" :class="type === 'dark' ? 'bg-default': ''">
    <div class="card-header border-0"
          ...
          <div class="row">
            <div class="col-sm-6">
              <transition name="fade">
                <div class="form-group mb-sm-0" v-if="searchForm.show_filter">
      ...
      <div class="row">
        <div class="col-md-12">
          <base-button type="primary" @click="create" class="mt-2">Create location</base-button>
        </div>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      create() {
        this.$router.push({ name: "location-create"} );
      }
    },
  }
</script>
