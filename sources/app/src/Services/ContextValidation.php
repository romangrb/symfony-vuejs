...
{
    /**
     * Violation sentence hash
     */
    const VIOLATION_SENTENCE = [
        'anus'=>'butt',
        'arse'=>'butt',
        'arsehole'=>'butt',
        'ass'=>'butt',
    ...
    /**
     * Check sentence and return hash matched
     *
     * @param string $context
     * @return array
     */
    public static function contextValidChecker(string $context): array
    {
        $matched = [];

        foreach(self::VIOLATION_SENTENCE as $key => $val){
            if(preg_match("/{$key}/i", $context)) {
                $matched[] = $key;
            }
        }
