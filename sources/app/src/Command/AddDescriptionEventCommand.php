...
class AddDescriptionEventCommand extends Command
{
    /**
     * Command name
     */
    protected static $defaultName = 'event:send-event';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): void
    {
        ...
        $output->writeln([
            '*************************************',
            '*Run command event-send-command     *',
            '*************************************'
        ]);
        ...
        $this->producer->sendEvent('event-topic', $message);
    }
}